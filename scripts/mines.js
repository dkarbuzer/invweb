...
if (language === "ru") {
    ...
    minesCountTitle.innerText = "जालों की संख्या";
    buttonGetSignal.innerText = "सिग्नल प्राप्त करें";
} else if (language === "tr") {
    minesCountTitle.innerText = "tuzak sayısı";
    buttonGetSignal.innerText = "sinyal al";
} else if (language === "es") {
    minesCountTitle.innerText = "cantidad de trampas";
    buttonGetSignal.innerText = "obtener señal";
} else {
